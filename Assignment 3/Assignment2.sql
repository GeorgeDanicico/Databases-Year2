...
-- INSERT STATEMENTS.
-- INSERT INTO MAPS
INSERT INTO Map (map_name) values ('de_dust2');
INSERT INTO Map (map_name) values ('de_mirage');
INSERT INTO Map (map_name) values ('de_nuke');
INSERT INTO Map (map_name) values ('de_vertigo');
INSERT INTO Map (map_name) values ('de_inferno');
...
INSERT INTO Weapon_Cases(case_type) values ('Break Out Case');
-- INSERT INTO DROP
...
INSERT INTO Items(case_id, condition, rarity, weapon, skin_name, price) 
	VALUES (6, 'field-tested', 'mil-spec', 'Butterfly Knife', 'Crimson Web', 100);
INSERT INTO Items(case_id, condition, rarity, weapon, skin_name, price) 
	VALUES (8, 'well-worn', 'covert', 'Gloves', 'Rainbow Paradise', 200);
INSERT INTO Items(case_id, condition, rarity, weapon, skin_name, price) 
	VALUES (1, 'factory-new', 'covert', 'P90', 'Asiimov', 100);
INSERT INTO Items(case_id, condition, rarity, weapon, skin_name, price) 
	VALUES (8, 'battle-scared', 'covert', 'P250', 'Asiimov', 70);
--INSERT INTO Items(case_id, condition, rarity, weapon, skin_name, price) 
...
INSERT INTO Players (firstName, lastName, age, nickname) values ('Anton', 'Pann', 17, 't3rminator');
...
-- INSERT INTO ARENAS
INSERT INTO Arenas (capacity, city, street, arena_name) values (15000, 'Cluj Napoca', 'Parcul Central', 'Sala Polivalenta');
INSERT INTO Arenas (capacity, city, street, arena_name) values (5000, 'Carei', 'Zamfirescu 2', 'Sala Gheorghe Tadici');
INSERT INTO Arenas (capacity, city, street, arena_name) values (15000, 'Arad', 'Cuza Voda 1', 'Sala Mare');
INSERT INTO Arenas (capacity, city, street, arena_name) values (20000, 'Cluj Napoca', 'Bogdan Petriceiu Hasdeu 92', 'Sala Horia Demian');
INSERT INTO Arenas (capacity, city, street, arena_name) values (2500, 'Satu Mare', 'Balcescu 65', 'Sala Sporturilor');
-- INSERT INTO BONUS
INSERT INTO Bonus (bonus_description) values ('Free Food');
INSERT INTO Bonus (bonus_description) values ('VIP seats');
INSERT INTO Bonus (bonus_description) values ('Free Signatures');
INSERT INTO Bonus (bonus_description) values ('Monster Energy Bonus Pack');
INSERT INTO Bonus (bonus_description) values ('Blackjack 1 entry');
-- INSERT INTO TICKETS
INSERT INTO Tickets (arena_id, price) values (1, 150);
INSERT INTO Tickets (arena_id, price) values (1, 100);
INSERT INTO Tickets (arena_id, price) values (1, 250);
INSERT INTO Tickets (arena_id, price) values (2, 50);
INSERT INTO Tickets (arena_id, price) values (3, 25);
INSERT INTO Tickets (arena_id, price) values (4, 100);
INSERT INTO Tickets (arena_id, price) values (4, 300);
INSERT INTO Tickets (arena_id, price) values (4, 500);
